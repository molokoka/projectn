# N-Queens Puzzle — Assignment

## Problem Statement

Build an Android application where the player plays a puzzle game based on the
N-Queens problem. The user's goal is to place n queens on an nxn chessboard such
that no two queens threaten each other (no same row, column, or diagonal).

While we don't mind you leverage modern code generation tools, we expect you to
fully understand and own 100% of the code and disclose the extent of their use in
your workflow.
...
- During the follow up interview you will walk us through the code and we will
  build an extension together so feel comfortable with presenting and working on
  the codebase.
...
- A short video of your app, feel free to edit it or add a voice over in case you
  want to improve its presentation.
- Use Kotlin
